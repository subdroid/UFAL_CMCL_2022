...
if __name__ == '__main__':
    ...
    log.info("Loading ROBERTA tokenizer and model")
    B_tok, B_model = model_selector("roberta")
    ...
    SAVE_PATH = os.path.join(os.getcwd(),os.path.join("saved_models","ROBERTA_TRTAvg_100.pt"))
